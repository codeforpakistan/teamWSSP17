            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php if(isset($multiListingData)) foreach($multiListingData as $row){?>
                <tr>
                  ...
                  <a onclick="return confirm('Are you sure you want to delete this?');" href="main/web_comp/udelete/<?=$row->c_id?>" class="btn" style="background-color:#d73925; color: #fff;"><i class="fa fa-fw fa-close"></i></a>
                  <?php }?>
