            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php if(isset($multiListingData)) foreach($multiListingData as $row){?>
                <tr>
                  ...
                  <td><a onclick="return confirm('Are you sure you want to delete this?');" href="main/web_comp/idelete/<?=$row->c_id?>" class="btn" style="background-color:#d73925; color: #fff;"><i class="fa fa-fw fa-close"></i></a>
                    <a href="main/web_comp/iedit/<?=$row->c_id?>" class="btn" style="background-color: #222d32;color: #fff; "><i class="fa fa-fw fa-edit"></i></a></td>
                </tr>
                <?php }?>
              </tbody>
              <tfoot>
